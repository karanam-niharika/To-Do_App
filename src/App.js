    ...
    <div className='min-h-screen flex items-center justify-center bg-gradient-to-r from-blue-600 to-emerald-400'>
      ...
      <div className="bg-white shadow-lg rounded-3xl p-16">
        ...
        <div className="mb-4 flex">
          ...
          <input value={input} onChange={(e) => setInput(e.target.value)} type="text" placeholder="Add a new todo" className="flex-grow px-3 py-2 border rounded-l-lg 
        ...
        {
          todos.map((todo) => (
            <li key={todos.id} className="flex items-center p-3 rounded-lg bg-slate-100 border border-gray-200">



              {/* <input type="checkbox"  checked={todo.completed} onChange={() =>  setTodos (todos.map((t) => {
